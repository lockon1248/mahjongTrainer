...
11. 完整牌型台數實作與驗證
   - current active child change：`taiwan-mahjong-complete-scoring-implementation`
   - current phase：proposal / design / tasks
   - 主線 task 完成條件：本 change 完成 scoring code、unit tests、browser E2E 並 archive 後回填
...
11. 完整牌型台數實作與驗證
   - 待 scoring code、測試與 E2E 全部落地後回填
12. 和牌資訊 UI 新增與優化
   - 待胡牌彈窗與 AI 和牌牌型顯示完成後回填
