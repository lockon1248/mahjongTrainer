...
describe('game table view', () => {
  ...
  it('renders the table only after match setup is submitted', async () => {
    ...
    expect(wrapper.find('[data-testid="game-stage-shell"]').exists()).toBe(true)
    expect(wrapper.find('[data-testid="game-stage-frame"]').exists()).toBe(true)
    expect(wrapper.find('[data-testid="game-stage-scaler"]').exists()).toBe(true)
    expect(wrapper.get('[data-testid="game-stage-shell"]').classes()).toContain('game-stage-shell--expanded')
    expect(wrapper.get('[data-testid="game-stage-frame"]').classes()).toContain('game-stage-frame--expanded')
    expect(wrapper.get('[data-testid="game-stage-frame"]').classes()).toContain('game-stage-frame--wide')
    expect(wrapper.get('[data-testid="game-stage-frame"]').classes()).toContain('game-stage-frame--rebalanced')
    expect(wrapper.get('[data-testid="game-stage-frame"]').classes()).toContain('game-stage-frame--wide-desktop')
    expect(wrapper.get('[data-testid="game-stage-scaler"]').classes()).toContain('game-stage-scaler--wide')
    expect(wrapper.get('[data-testid="game-stage-scaler"]').classes()).toContain('game-stage-scaler--rebalanced')
    expect(wrapper.get('[data-testid="game-stage-scaler"]').classes()).toContain('game-stage-scaler--wide-desktop')
